...
{
    /**
     * @var Pest\Expectations\OppositeExpectation
     */
    public OppositeExpectation $not;

    /**
     * @var Pest\Expectations\EachExpectation
     */
    public EachExpectation $each;

    /**
     * @var Pest\Arch\PendingArchExpectation
     */
    public PendingArchExpectation $classes;

    /**
     * @var Pest\Arch\PendingArchExpectation
     */
    public PendingArchExpectation $traits;

    /**
     * @var Pest\Arch\PendingArchExpectation
     */
    public PendingArchExpectation $interfaces;

    /**
     * @var Pest\Arch\PendingArchExpectation
     */
    public PendingArchExpectation $enums;
    ...
    public function toBe(array $expected_groups)
    {
    }
}
